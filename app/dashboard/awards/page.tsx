      ...
      <div className="px-4 pt-4 sm:px-6 sm:pt-6">
        <div className="rounded-panel border border-border bg-clay-soft px-5 py-4">
          ...
          <p className="mt-1.5 text-sm text-ink-soft">
            This will become the <span className="font-medium text-clay-ink">Award Interpreter</span>. For now, it is general HR chat - ask about pay rates, classifications, or any award question and the advisor will help.
          </p>
        </div>
      </div>
