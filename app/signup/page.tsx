...
// "Get started" / "Subscribe" click 404'd - the entire interest -> signup
// funnel was broken at the first click.
//
// It redirects into the existing login page in signup mode, preserving
// the plan / cycle query params so the user's pricing choice flows
// through signup into onboarding.
...
export default async function SignupPage({
  ...
  qs.set('mode', 'signup')
  for (const key of ['plan', 'cycle'] as const) {
    const v = params[key]
