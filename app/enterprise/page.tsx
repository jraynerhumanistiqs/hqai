...
//
// The model is hours-based and sales-assisted: a named Humanistiqs advisor
...
const PAGE_DESCRIPTION =
  'A named Humanistiqs advisor on call for the hard 20% of your HR or your hiring, with HQ.ai doing the admin behind them.'
...
const FAQS: Array<{ q: string; a: string }> = [
  {
    ...
    a: 'HR365 is a named Humanistiqs HR advisor on call for the hard parts of HR - the tricky stuff the AI cannot decide for you. Recruit365 is the same idea for hiring: a named talent advisor on call to run the roles you have no time to run. The AI does the admin in both. Take one, or take both as HR365 + Recruit365 and get one coordinated team.',
  },
  {
  ...
  },
  {
    ...
    a: 'Yes. You get one named person, with a photo, a short bio and a direct mobile number. You meet them before you sign, not after. If they are not the right fit, we match you with someone else.',
  },
  {
...
const HOW_IT_WORKS = [
  ...
  { step: '02', title: 'Written scope', body: 'Within 5 business days of the call. We put the work, the hours, the rhythm and your named advisor in writing. A PDF plus a draft invoice.' },
        ...
        <section className="relative isolate overflow-hidden" aria-labelledby="enterprise-hero">
          <div className="mx-auto max-w-5xl px-6 pb-16 pt-16 text-center md:px-10 md:pb-24 md:pt-24">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-ink-soft md:text-xl">
              A named Humanistiqs advisor on call for the hard 20% of HR or your hiring. The AI does
        ...
        <section id="variants" className="bg-bg-soft py-20 md:py-28" aria-labelledby="variants-heading">
          <div className="mx-auto max-w-6xl px-6 md:px-10">
            ...
            <p className="mt-4 max-w-2xl text-base text-ink-soft md:text-lg">
              ...
              HR365 + Recruit365 when you want one team across both. Every plan is a named advisor on
              ...
              <table className="w-full text-left text-sm">
                ...
                <tbody className="divide-y divide-border">
                  <tr>
                    ...
                    <td className="px-5 py-4 text-ink-soft">An office manager or ops lead does HR on the side and wants one named person for the tricky stuff, with a few advisor hours each month.</td>
                  </tr>
                  <tr>
                    <td className="px-5 py-4 font-semibold text-ink">Recruit365</td>
                    <td className="px-5 py-4 text-ink-soft">You are sick of agency fees, you do not want an in-house recruiter, and you want a named talent advisor on call to run your hiring.</td>
                  </tr>
                  <tr>
