...
- Read the ad's location intent carefully before adding any physical-location requirement:
  ...
  - Only add a physical-location requirement (e.g. "based in or able to commute to <place>") when the ad clearly requires on-site or hybrid attendance at a specific location. Even then, make it an ordinal_5 criterion, not a hard gate, unless the ad states attendance is mandatory.
