          ...
          <div className="grid items-center gap-10 md:grid-cols-[2fr_3fr] md:gap-14">
            ...
            <div>
              <blockquote className="font-display text-[22px] font-bold leading-snug tracking-tight text-ink md:text-[26px]">
                &ldquo;I cancelled our $850 a month outsourced HR retainer in the second week. The HQ People Advisor answered my questions in minutes - the same questions I was put on a 20 minute hold for by my previous provider. And when we had two roles to fill, HQ Recruit did the sorting for us.&rdquo;
              </blockquote>
